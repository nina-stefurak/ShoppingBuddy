...
using ShoppingBuddyWebApp.Data;
using ShoppingBuddyWebApp.Models;

namespace ShoppingBuddyWebApp.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Product")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Product")] ShoppingCart shoppingCart)
        {
